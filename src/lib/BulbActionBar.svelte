...
<fieldset class="buttonbunch">
    ...
    &nbsp;
    <TinyColorButtons palette={planckian_colors} on:color_chosen={tinyColorChosenSelected} />
    &nbsp;
    <TinyColorButtons palette={general_colorful_colors} on:color_chosen={tinyColorChosenSelected} />
</fieldset>
