...
<fieldset class="buttonbunch">
    ...
    <button on:click={ () => phue.setSelectionAll(true)}>All</button>
    <button on:click={ () => phue.setSelectionAll(false)}>None</button>
    <button on:click={ () => phue.setSelectionAll(-1)}>Inv</button>
